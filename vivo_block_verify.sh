...
ver_MN01()
{
	if [ "$MNBLOCK01" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK01" -le "$EXPBLOCKHIGH" ]; then
	  ...
	  echo "$(date +%F_%T) Masternode 01 in aggiornamento"
...
ver_MN02()
{
	if [ "$MNBLOCK02" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK02" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 02 OK"
	else
	  echo "$(date +%F_%T) Masternode 02 in aggiornamento"
...
ver_MN03()
{
	if [ "$MNBLOCK03" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK03" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 03 OK"
	else
	  echo "$(date +%F_%T) Masternode 03 in aggiornamento"
...
ver_MN04()
{
	if [ "$MNBLOCK04" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK04" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 04 OK"
	else
	  echo "$(date +%F_%T) Masternode 04 in aggiornamento"
...
ver_MN05()
{
	if [ "$MNBLOCK05" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK05" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 05 OK"
	else
	  echo "$(date +%F_%T) Masternode 05 in aggiornamento"
...
ver_MN06()
{
	if [ "$MNBLOCK06" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK06" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 06 OK"
	else
	  echo "$(date +%F_%T) Masternode 06 in aggiornamento"
...
ver_MN07()
{
	if [ "$MNBLOCK07" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK07" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 07 OK"
	else
	  echo "$(date +%F_%T) Masternode 07 in aggiornamento"
...
ver_MN08()
{
	if [ "$MNBLOCK08" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK08" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 08 OK"
	else
	  echo "$(date +%F_%T) Masternode 08 in aggiornamento"
...
ver_MN09()
{
	if [ "$MNBLOCK09" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK09" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 09 OK"
	else
	  echo "$(date +%F_%T) Masternode 09 in aggiornamento"
...
ver_MN10()
{
	if [ "$MNBLOCK10" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK10" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 10 OK"
	else
	  echo "$(date +%F_%T) Masternode 10 in aggiornamento"
...
ver_MN11()
{
	if [ "$MNBLOCK11" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK11" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 11 OK"
	else
	  echo "$(date +%F_%T) Masternode 11 in aggiornamento"
...
ver_MN12()
{
	if [ "$MNBLOCK12" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK12" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 12 OK"
	else
	  echo "$(date +%F_%T) Masternode 12 in aggiornamento"
...
ver_MN13()
{
	if [ "$MNBLOCK13" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK13" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 13 OK"
	else
	  echo "$(date +%F_%T) Masternode 13 in aggiornamento"
...
ver_MN14()
{
	if [ "$MNBLOCK14" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK14" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 14 OK"
	else
	  echo "$(date +%F_%T) Masternode 14 in aggiornamento"
...
ver_MN15()
{
	if [ "$MNBLOCK15" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK15" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 15 OK"
	else
	  echo "$(date +%F_%T) Masternode 15 in aggiornamento"
...
ver_MN16()
{
	if [ "$MNBLOCK16" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK16" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 16 OK"
	else
	  echo "$(date +%F_%T) Masternode 16 in aggiornamento"
...
ver_MN17()
{
	if [ "$MNBLOCK17" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK17" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 17 OK"
	else
	  echo "$(date +%F_%T) Masternode 17 in aggiornamento"
...
ver_MN18()
{
	if [ "$MNBLOCK18" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK18" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 18 OK"
	else
	  echo "$(date +%F_%T) Masternode 18 in aggiornamento"
...
ver_MN19()
{
	if [ "$MNBLOCK19" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK19" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 19 OK"
	else
	  echo "$(date +%F_%T) Masternode 19 in aggiornamento"
...
ver_MN20()
{
	if [ "$MNBLOCK20" -ge "$EXPBLOCKLOW" ] && [ "$MNBLOCK20" -le "$EXPBLOCKHIGH" ]; then
	  echo "$(date +%F_%T) Masternode 20 OK"
	else
	  echo "$(date +%F_%T) Masternode 20 in aggiornamento"
